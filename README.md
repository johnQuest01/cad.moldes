...
por log de eventos e o backend. **Fase 1 fechada: 201 testes passando** (164 motor + 18 persistência
+ 19 API).
...
npm run demo        # a demonstração navegável, em http://localhost:5199
```
