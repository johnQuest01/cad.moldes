...
por log de eventos e o backend. **Fases 1 a 5 completas, Fase 6 começada: 422 testes passando** (192 motor + 141 editor + 14 DXF + 9 plotter +
11 encaixe + 18 foto + 18 persistência + 19 API).
...
| `@cad/foto` | digitalizar molde por foto: calibração, homografia, segmentação e contorno |
